...
client.on("message", msg => {
    ...
    if (msg.content === "!help") {
        ...
        "\n `!start` Give me a date in the future, and I'll assign everyone their Secret Santa and set a countdown before the event ends. Entering and leaving will no longer be available. Only available to the host" +
